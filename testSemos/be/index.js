...
const { getAll, getOne, create, update, remove } = require("./handlers/faculty");
...
api.get("/api/facs", getAll);
api.get("/api/facs/:id", getOne);
api.post("/api/facs", create);
api.put("/api/facs/:id", update);
api.delete("/api/facs/:id", remove);
api.get("/api/add-fac", (req, res) => {
    res.render("add-fac");
  });
